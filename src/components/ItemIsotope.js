    ...
    <Fragment>
      ...
      <div className="box-items portfolio-items">
        <div className="box-item f-gallery">
          ...
          <div className="image">
            <Link href="#gallery-1" className="has-popup-gallery hover-animated"><a>
            ...
            <div id="gallery-1" className="mfp-hide">
              <Link href="images/work1.jpg" />
              <Link href="images/work2.jpg" />
              <Link href="images/work3.jpg" />
              <Link href="images/work4.jpg" />
            </div>
          </div>
        </div>
        ...
        <div className="box-item f-gallery">
          <div className="image">
            <Link href="#gallery-2" className="has-popup-gallery hover-animated"><a>
        ...
        <div className="box-item f-content">
          <div className="image">
            <Link href="#popup-1" className="has-popup-media hover-animated"><a>
